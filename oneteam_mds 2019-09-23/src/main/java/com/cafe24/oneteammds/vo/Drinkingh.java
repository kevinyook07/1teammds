...
public class Drinkingh {
	...
	public String toString() {
		return "Drinkingh [dcCode=" + dcCode + ", hospitalId=" + hospitalId + ", patientId=" + patientId + ", dccName="
				+ dccName + ", pDoctor=" + pDoctor + ", adminId=" + adminId + ", dcrDate=" + dcrDate + "]";
	}
