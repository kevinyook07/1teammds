...
public class Ginuengh {
	...
	public void setFtdTime(String ftdTime) {
		this.ftdTime = ftdTime;
	}
	...
	public String toString() {
		return "Ginuengh [ftrCode=" + ftrCode + ", hospitalId=" + hospitalId + ", patientId=" + patientId + ", ftName="
				+ ftName + ", ftCode=" + ftCode + ", ftrValue=" + ftrValue + ", pDoctor=" + pDoctor + ", ftdTime="
				+ ftdTime + ", adminId=" + adminId + ", ftrDate=" + ftrDate + "]";
	}
