...
public class GinuenghA_Controller {
	...
	public String getGinuenghById(@RequestParam(value = "patientId") String patientId, Model model) {
		...
		return "ginueng/ginuengRegist/ginuenghA_Regist";
	}

	
	@PostMapping("/ginuenghA_List")
