...
public class ByungrihA_Controller {
	...
	public String getByungrihById(@RequestParam(value = "patientId") String patientId, Model model) {
		...
		return "byungri/byungriRegist/byungrihA_Regist";
	}
	
	@PostMapping("/byungrihA_List")
