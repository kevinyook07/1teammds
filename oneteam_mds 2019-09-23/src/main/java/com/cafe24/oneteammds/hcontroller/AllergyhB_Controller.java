...
public class AllergyhB_Controller {
	...
	public String getAllergyhById(@RequestParam(value = "patientId") String patientId, Model model) {
		...
		return "allergy/allergyRegist/allergyhB_Regist";
	}
	@PostMapping("/allergyhB_List")
