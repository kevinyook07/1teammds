...
public class SmokinghC_Controller {
	...
	public String getSmokinghById(@RequestParam(value = "patientId") String patientId, Model model) {
		...
		return "smoking/smokingRegist/smokinghC_Regist";
	}
	
	@PostMapping("/smokinghC_List")
