...
public class YoungsanghB_Controller {
	...
	public String getYoungsanghById(@RequestParam(value = "patientId") String patientId, Model model) {
		...
		return "youngsang/youngsangRegist/youngsanghB_Regist";
	}

	@PostMapping("/youngsanghB_List")
