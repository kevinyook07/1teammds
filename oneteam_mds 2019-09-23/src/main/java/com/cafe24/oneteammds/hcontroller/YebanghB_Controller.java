...
public class YebanghB_Controller {
	...
	public String getYebanghById(@RequestParam(value = "patientId") String patientId, Model model) {
		...
		return "yebang/yebangRegist/yebanghB_Regist";
	}

	@PostMapping("/yebanghB_List")
