...
public class PandoghB_Controller {
	...
	public String getPandoghById(@RequestParam(value = "patientId") String patientId, Model model) {
		...
		return "pandog/pandogRegist/pandoghB_Regist";
	}

	@PostMapping("/pandoghB_List")
