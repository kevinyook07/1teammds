...
public class SmokinghA_Controller {
	...
	public String getSmokinghById(@RequestParam(value = "patientId") String patientId, Model model) {
		...
		return "smoking/smokingRegist/smokinghA_Regist";
	}
	
	@PostMapping("/smokinghA_List")
