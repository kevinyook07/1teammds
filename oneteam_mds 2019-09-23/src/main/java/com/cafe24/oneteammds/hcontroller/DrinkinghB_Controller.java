...
public class DrinkinghB_Controller {
	...
	public String getDrinkinghById(@RequestParam(value = "patientId") String patientId, Model model) {
		...
		return "drinking/drinkingRegist/drinkinghB_Regist";
	}

	
	@PostMapping("drinkinghB_List")
