...
public class GumchehA_Controller {
	...
	public String getGumchehById(@RequestParam(value = "patientId") String patientId, Model model) {
		...
		return "gumche/gumcheRegist/gumchehA_Regist";
	}

	@PostMapping("/gumchehA_List")
