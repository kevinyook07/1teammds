...
public class GinuenghB_Controller {
	...
	public String getGinuenghById(@RequestParam(value = "patientId") String patientId, Model model) {
		...
		return "ginueng/ginuengRegist/ginuenghB_Regist";
	}

	
	@PostMapping("/ginuenghB_List")
