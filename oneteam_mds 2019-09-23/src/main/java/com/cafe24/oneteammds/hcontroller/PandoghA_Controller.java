...
public class PandoghA_Controller {
	...
	public String getPandoghById(@RequestParam(value = "patientId") String patientId, Model model) {
		...
		return "pandog/pandogRegist/pandoghA_Regist";
	}

	@PostMapping("/pandoghA_List")
