...
public class YebanghA_Controller {
	...
	public String getYebanghById(@RequestParam(value = "patientId") String patientId, Model model) {
		...
		return "yebang/yebangRegist/yebanghA_Regist";
	}

	@PostMapping("/yebanghA_List")
