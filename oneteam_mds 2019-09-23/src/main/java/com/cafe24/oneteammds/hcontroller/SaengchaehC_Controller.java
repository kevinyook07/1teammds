...
public class SaengchaehC_Controller {
	...
	public String getSaengchaehById(@RequestParam(value = "patientId") String patientId, Model model) {
		...
		return "saengchae/saengchaeRegist/saengchaehC_Regist";
	}

	@PostMapping("/saengchaehC_List")
