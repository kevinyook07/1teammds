...
public class DrinkinghC_Controller {
	...
	public String getDrinkinghById(@RequestParam(value = "patientId") String patientId, Model model) {
		...
		return "drinking/drinkingRegist/drinkinghC_Regist";
	}

	
	@PostMapping("drinkinghC_List")
