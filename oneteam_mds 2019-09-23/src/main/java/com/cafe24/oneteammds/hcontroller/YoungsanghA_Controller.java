...
public class YoungsanghA_Controller {
	...
	public String getYoungsanghById(@RequestParam(value = "patientId") String patientId, Model model) {
		...
		return "youngsang/youngsangRegist/youngsanghA_Regist";
	}

	@PostMapping("/youngsanghA_List")
