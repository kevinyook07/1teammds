...
public class SaengchaehA_Controller {
	...
	public String getSaengchaehById(@RequestParam(value = "patientId") String patientId, Model model) {
		...
		return "saengchae/saengchaeRegist/saengchaehA_Regist";
	}

	@PostMapping("/saengchaehA_List")
