...
public class JindanhA_Controller {
	...
	public String getJindanhById(@RequestParam(value = "patientId") String patientId, Model model) {
		...
		return "/jindan/jindanRegist/jindanhA_Regist";
	}

	@PostMapping("/jindanhA_List")
