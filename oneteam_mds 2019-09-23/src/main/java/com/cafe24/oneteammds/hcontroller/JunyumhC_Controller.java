...
public class JunyumhC_Controller {
	...
	public String getJunyumhById(@RequestParam(value = "patientId") String patientId, Model model) {
		...
		return "junyum/junyumRegist/junyumhC_Regist";
	}

	@PostMapping("/junyumhC_List")
