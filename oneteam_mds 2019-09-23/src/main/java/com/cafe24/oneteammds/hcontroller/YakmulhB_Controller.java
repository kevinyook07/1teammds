...
public class YakmulhB_Controller {
	...
	public String getYakmulhById(@RequestParam(value = "patientId") String patientId, Model model) {
		...
		return "yakmul/yakmulRegist/yakmulhB_Regist";
	}

	@PostMapping("/yakmulhB_List")
