...
public class ByungrihC_Controller {
	...
	public String getByungrihById(@RequestParam(value = "patientId") String patientId, Model model) {
		...
		return "byungri/byungriRegist/byungrihC_Regist";
	}
	
	@PostMapping("/byungrihC_List")
