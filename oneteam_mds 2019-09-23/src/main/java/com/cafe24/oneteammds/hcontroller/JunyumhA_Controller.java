...
public class JunyumhA_Controller {
	...
	public String getJunyumhById(@RequestParam(value = "patientId") String patientId, Model model) {
		...
		return "junyum/junyumRegist/junyumhA_Regist";
	}

	@PostMapping("/junyumhA_List")
