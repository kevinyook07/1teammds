...
public class SusulhC_Controller {
	...
	public String getSusulhById(@RequestParam(value = "patientId") String patientId, Model model) {
		...
		return "susul/susulRegist/susulhC_Regist";
	}

	@PostMapping("/susulhC_List")
